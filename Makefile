...
BLOBS += libbs.wasm
BLOBS += libjanne_complex.wasm
BLOBS += compress_test.wasm
#BLOBS += mont64.wasm
BLOBS += libbubblesort.wasm
BLOBS += libcompress.wasm
BLOBS += libcrc.wasm
BLOBS += libns.wasm
BLOBS += aes.wasm
#BLOBS += aesxam.wasm
#BLOBS += arcfour.wasm
BLOBS += arraybinsearch.wasm
BLOBS += arraysort.wasm
BLOBS += basicmath_small.wasm
BLOBS += cast128.wasm
BLOBS += cnt.wasm
BLOBS += crc_32.wasm
#BLOBS += ctl.wasm
BLOBS += des.wasm
BLOBS += dijkstra_small.wasm
BLOBS += dllist.wasm
BLOBS += ef_exp.wasm
BLOBS += ef_log.wasm
BLOBS += ef_mod.wasm
BLOBS += ef_sqrt.wasm
BLOBS += fast_fwd_inc.wasm
BLOBS += fast_rev_d12.wasm
BLOBS += hashtable.wasm
#BLOBS += libcubic.wasm
BLOBS += libdtoa.wasm
BLOBS += libduff.wasm
BLOBS += libedn.wasm
BLOBS += libexpint.wasm
BLOBS += libfac.wasm
BLOBS += libfasta.wasm
BLOBS += libfdct.wasm
BLOBS += libfibcall.wasm
BLOBS += libfir.wasm
BLOBS += libfrac.wasm
BLOBS += libhuffbench.wasm
BLOBS += libinsertsort.wasm
BLOBS += libjfdctint.wasm
BLOBS += liblcdnum.wasm
BLOBS += liblevenshtein.wasm
BLOBS += libludcmp.wasm
BLOBS += libmergesort.wasm
BLOBS += libminver.wasm
BLOBS += libndes.wasm
BLOBS += libnsichneu.wasm
BLOBS += libpicojpeg.wasm
BLOBS += libprime.wasm
BLOBS += libqsort.wasm
BLOBS += libqurt.wasm
BLOBS += librecursion.wasm
BLOBS += libselect.wasm
BLOBS += libslre.wasm
BLOBS += libsqrt.wasm
BLOBS += libst.wasm
BLOBS += libstb_perlin.wasm
BLOBS += libstatemate.wasm
BLOBS += libstrstr.wasm
BLOBS += libtarai.wasm
BLOBS += libtemplate.wasm
BLOBS += libud.wasm
BLOBS += libwhetstone.wasm
BLOBS += libwikisort.wasm
BLOBS += listinsertsort.wasm
BLOBS += listsort.wasm
#BLOBS += matmult.wasm
BLOBS += md5.wasm
BLOBS += miniz_b.wasm
BLOBS += miniz.wasm
BLOBS += nbody.wasm
BLOBS += nettle-aes.wasm
BLOBS += nettle-sha256.wasm
BLOBS += picojpeg_test.wasm
BLOBS += qrencode.wasm
BLOBS += qrframe.wasm
BLOBS += qrtest.wasm
#BLOBS += queue.wasm
BLOBS += rbtree.wasm
BLOBS += string.wasm
BLOBS += stringsearch1.wasm
#BLOBS += trio.wasm
#BLOBS += triostr.wasm
#BLOBS += trio_test.wasm
